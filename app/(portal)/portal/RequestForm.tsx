...
const RequestForm = ({ user }: Props) => {
  ...
  return (
    <DialogWrapper
      btnTitle="Demander un congé"
      title="Soumettez votre demande de congé"
      descr="Assurez-vous de sélectionner les bonnes dates pour votre congé."
      isBtn={true}
      open={open}
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-[200px] p-0">
                    <Command>
                      ...
                      <CommandEmpty>Aucun type de congé trouvé.</CommandEmpty>
                      <CommandGroup>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Ajoutez des notes supplémentaires pour étayer votre demande.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
